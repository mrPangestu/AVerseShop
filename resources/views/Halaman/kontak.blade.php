...
<div class="container-main container-fluid d-flex justify-content-center align-items-center pb-5 px-0" >
    <div class="contact-container container-md mx-0" style="width:60%; height:auto;">
        <div class="contact-row row m-0">
            <!-- Kolom dengan Google Maps -->
            <div class="col-md-6 col-12 p-0" id="map-container">
              <iframe 
            ...
            <!-- Kolom dengan form -->
            <div class="col-md-6 col-12 text-center" style="background: blueviolet;">
